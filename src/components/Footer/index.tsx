...
import { AiOutlineArrowRight, AiOutlineInstagram, AiOutlineTwitter, AiFillYoutube } from 'react-icons/ai';
    ...
    return (
        <FooterStyle>
                ...
                <div className="ContainerContatoFooter">
                    <label>
                        ...
                        <div>
                            ...
                            <i><BiEnvelope /></i>
                            <button><BiEnvelope /><AiOutlineArrowRight /></button>
                        </div>
                    </label>
            ...
            <div className="RodapeFooter">
                <p>2023 Instituto de Educação e Cidadania.Todos os direitos reservados</p>
            </div>
        </FooterStyle>
    )
}
